...
class CollidableObject():
    ...
    def collide(self, collide_object):
        return collide_object.y + collide_object.x > self.y and collide_object.x + collide_object.width > self.x and collide_object.x <self.x + collide_object.width
